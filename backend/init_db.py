...
con.executemany('INSERT INTO bills (user_id, amount_due, due_date, description, paid) VALUES (?, ?, ?, ?, FALSE)', [
    (1, 12300, '2000-01-01 12:30:00.000', 'Mortgage'),
    (1, 12400, '2001-01-01 12:30:00.000', 'Mansion Mortgage'),
    (1, 12500, '2002-01-01 12:30:00.000', 'Mansion 2 Mortgage'),
    (2, 100, '2003-01-01 12:30:00.000', '2012 Nissan Altima'),
    (2, 50, '2004-01-01 12:30:00.000', 'Lamborghini Aventador'),
    (3, 100000, '2005-01-01 12:30:00.000', 'Electricity'),
])
